...
{
    if (id != -1)    
        //simxGetObjectPosition(id,sensorHandle,-1,coord,simx_opmode_buffer);
...
{
    if (id != -1)
        //simxGetObjectOrientation(id,sensorHandle,-1,coord,simx_opmode_buffer);
...
{
    if (id != -1)
        //simxGetJointPosition(id,jointHandle,coord,simx_opmode_buffer);
...
int Simulator::setJointTargetVelocity(simxInt jointHandle, float velocity) {
    if (id != -1)
        //simxSetJointTargetVelocity(id, jointHandle, velocity, simx_opmode_buffer);
